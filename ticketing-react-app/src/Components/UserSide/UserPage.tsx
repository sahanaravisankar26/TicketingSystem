...
const UserPage = ({ userData, onLogout }: {userData: {email: string}, onLogout: () => void}) => {
  useEffect(() => {
    ...
    fetch("http://localhost:8080/protected", {
      ...
      // make a toastify of message
  }, []);

  return (
    <div className="pb-4 bg-white">
      <Navbar onLogout={onLogout} />
      <h6 className="text-2xl font-bold text-center mt-4">Welcome {userData.email}!</h6>
      <Routes>
